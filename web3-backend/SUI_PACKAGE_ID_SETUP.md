...
### Option 1: Netlify (Nếu đang dùng Netlify)

1. **Vào Netlify Dashboard:**
   - https://app.netlify.com
   - Chọn site `web3farming`
...
4. **Deploy lại:**
   - Netlify sẽ tự động deploy lại khi có env vars mới
...
```bash
# Test health
curl https://web3farming.netlify.app/.netlify/functions/health

# Test query NFTs (với wallet address thật)
curl "https://web3farming.netlify.app/.netlify/functions/nfts?wallet=0x8e2c64a60b96346cd780d95e9b9600630af06c9ee198dc0b59256d1f982df532"
```
