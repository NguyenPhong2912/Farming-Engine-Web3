...
## Bước 4: Setup Environment Variables trong Netlify

1. Vào Netlify Dashboard → Site → **Environment variables**
...
- Chỉ dùng trong Netlify Environment Variables
...
1. Deploy lại backend trên Netlify (sẽ tự động detect env vars mới)
...
Check logs trong Netlify Function logs để xem:
